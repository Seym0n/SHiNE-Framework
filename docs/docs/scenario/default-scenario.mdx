...
In the default scenario which you typically see when you spin up the base Docker (Compose) image, we have three rooms:
- a living room
- Bob's Room
- Your Room
...
The installation of the default scenario is explained in the GitHub ![README](https://github.com/ExmartLab/SHiNE-Framework/blob/master/README.md#option-2-using-pre-built-image-from-github-container-registry) of the repository.
